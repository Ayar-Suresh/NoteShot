...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // LINE VISIBILITY
          _buildAnimatedEntry(0, _buildSectionHeader('LINE VISIBILITY', Icons.visibility)),
          const SizedBox(height: 8),
          _buildAnimatedEntry(1, _buildToggleCard([
          ...
          // STYLE
          _buildAnimatedEntry(2, _buildSectionHeader('STYLE', Icons.palette)),
          const SizedBox(height: 8),
          _buildAnimatedEntry(3, _buildStyleCard()),
          const SizedBox(height: 20),

          // TIME FORMAT
          _buildAnimatedEntry(4, _buildSectionHeader('TIME FORMAT', Icons.access_time)),
          const SizedBox(height: 8),
          _buildAnimatedEntry(5, _buildTimeFormatCard()),
          const SizedBox(height: 20),

          // TEXT COLOR
          _buildAnimatedEntry(6, _buildSectionHeader('TEXT COLOR', Icons.color_lens)),
          const SizedBox(height: 8),
          _buildAnimatedEntry(7, _buildColorCard()),
          const SizedBox(height: 20),

          // PREVIEW
          _buildAnimatedEntry(8, _buildSectionHeader('PREVIEW', Icons.preview)),
          const SizedBox(height: 8),
          _buildAnimatedEntry(9, _buildPreviewCard()),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: const Color(0xFF00FFD1), size: 13),
          ),
  ...
  Widget _buildToggleCard(List<_ToggleItem> items) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFF00FFD1).withOpacity(0.08)),
      ),
      child: Column(
        ...
        children: [
          ...
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              ...
              overlayColor: const Color(0xFF00FFD1).withOpacity(0.1),
              trackHeight: 3,
            ),
            child: Slider(
              value: _fontSize,
          ...
          const SizedBox(height: 8),
          Divider(color: const Color(0xFF00FFD1).withOpacity(0.05)),
          const SizedBox(height: 8),
  ...
  Widget _buildPreviewCard() {
    final textColor =
        _textColors[_textColorIndex.clamp(0, _textColors.length - 1)];
    ...
    if (_showTime) {
      previewLines.add(_use24Hour
          ? 'Time:      18-06-2026 14:30'
          : 'Time:      18-06-2026 02:30 PM');
    }
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.black.withOpacity(_bgOpacity * 0.8),
            borderRadius: BorderRadius.circular(6),
            border: Border.all(
